        ...
        <div class="page-content">
            ...
            <div class="row" style="padding:0px;height:auto;overflow:hidden;margin-bottom:10px;">
                <div class="col-xs-12 col-sm-8">
                    <a class="btn btn-primary pull-left" style="padding:1px 10px;" href="<?php echo U('Admin/Goodsbrand/addBrand');?>">
                        ...
                        <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                                    ...
                                    <td><img src="/cheng/Public/Uploads/<?php echo (implode('/th_',explode('/',$vo['brandpic']))); ?>" alt="<?php echo ($ad['adpic']); ?>" width="80"></td>
                                    <td>
                                        <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                            <a name="table-edit" class="green" href="<?php echo U('Admin/Goodsbrand/modifyBrand',array('id'=>$vo['bid']));?>">
                                                <i class="icon-pencil bigger-130"></i>
                                            </a>

                                            <a name="del_<?php echo ($vo['bid']); ?>" class="red" data-toggle="modal" href="#deleteModal">
    ...
    <script type="text/javascript">
        jQuery(function($) {
            ...
            $('#delete-data').on('click',function(){
                $.ajax({
                       url:"/cheng/admin.php/Admin/Goodsbrand/deleteBrand",
                       type:"post",
                       data:{bid:delid},
