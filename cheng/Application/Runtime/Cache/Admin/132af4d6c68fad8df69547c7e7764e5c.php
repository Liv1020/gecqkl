...
<html lang="en">
	...
	<div class="main-content">
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<ul class="breadcrumb">
				<li>
					...
					<a href="/cheng/admin.php/admin">首页</a>
				</li>
		...
		<div class="page-content">
			...
			<div class="page-header">
				<h1>
					商品发布
					<a href="/cheng/admin.php/admin/Goodsup" class="btn btn-info btn-sm pull-right">
	...
	<div class="main-container">
		<div class="col-xs-9">
			<form class="form-horizontal" role="form" action="/cheng/admin.php/Admin/Goodsissue/insertGd" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<div class="col-sm-10"  id="selparent">
						<div id="menu-0" class="col-xs-10 col-sm-2  no-padding">
							<select name='pid1' class="form-control">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="col-xs-10 col-sm-5" placeholder="请输入规格" name="goods_spec">
					</div>
				</div>
				<div class="form-group">
	...
	<script type="text/javascript">
		jQuery(function($) {
			...
			$('#menu-0').parent().parent().nextAll().css('display','none');
             		//联动菜单
             		var n=1;
			$('#selparent').on('change','select',function(){n++;
				var parentid = 0;                       
				...
				var str = '<div id="menu-'+numbers+'" class="col-xs-10 col-sm-2  no-padding"><select name="pid'+n+'" class="form-control"></select></div>';
				...
				$.ajax({
					...
					success:function(data){
						...
						if (!datas.length) {
							...
							// ajax请求商品的属性
							$.ajax({
								url:"/cheng/admin.php/admin/Goodsissue/goodsAttr",
								type:'post',
								data:{cid:goodattrid},
								dataType:'json',
								success:function(data){
							...
							// ajax请求商品的品牌
							$.ajax({
								url:'/cheng/admin.php/admin/Goodsissue/goodsBrand',
								type:'post',
								data:{cid:goodattrid},
								dataType:'json',
								success:function(data){
		...
		//1 设置ueditor目录
		window.UEDITOR_HOME_URL = "/cheng/Public/admin/js/ueditor/";
	</script>
	<!-- 加载配置文件 2-->
	<script type="text/javascript" src="/cheng/Public/admin/js/ueditor/ueditor.config.js"></script>
	<!-- 加载编辑器源码文件3 -->
	<script type="text/javascript" src="/cheng/Public/admin/js/ueditor/ueditor.all.js"></script>
	<script type="text/javascript">
	//初始化编辑器，设定显示的按钮
