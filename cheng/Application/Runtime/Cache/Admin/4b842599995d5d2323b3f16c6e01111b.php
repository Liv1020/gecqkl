...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title><?php echo ($title); ?>——农链后台管理</title>
	...
	<div class="main-content">
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<ul class="breadcrumb">
				...
				<li>
					<a href="/cheng/admin.php/admin/goodsup">上架商品</a>
				</li>
	...
	<div class="main-container">
		<div class="col-xs-9">
			<form class="form-horizontal" role="form" action="/cheng/admin.php/Admin/Goodsup/updategoods" method="post" enctype="multipart/form-data">
				<!-- 商品编号 -->
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="col-xs-10 col-sm-5" placeholder="请输入规格" value="<?php echo ($goodsdata["goods_spec"]); ?>" name="goods_spec">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group" style="margin-bottom:0px;">
					...
					<div class="col-sm-10">
						...
						<?php if(is_array($goodsdata["gpic"])): foreach($goodsdata["gpic"] as $key=>$vo): ?><div class="col-sm-5" style="height:47px;">
								<img width="40" src="/cheng/Public/Goodsuploads/<?php echo (implode('/60_',explode('/',$vo))); ?>" >
