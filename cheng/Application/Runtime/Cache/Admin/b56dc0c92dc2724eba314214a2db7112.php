...
<html lang="en">
									...
									<table class="table table-striped table-bordered table-hover" id="sample-table-2">
										...
										<tbody>
												<?php if(is_array($orders_data)): $i = 0; $__LIST__ = $orders_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
														...
														<td class="center" ><?php echo ($v["order_price"]); ?></td>
														<td class="center" ><?php echo ($v["deliveryaddress"]); ?></td>
														<td class="center" >
															<?php switch($v["status"]): case "0": ?>待付款<?php break;?>
									...
									<table class="table table-striped table-bordered table-hover" id="sample-table-2">
										...
										<tbody>
												<?php if(is_array($orders_data)): $i = 0; $__LIST__ = $orders_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                                        ...
                                                        <td class="center" ><?php echo ($v["otime"]); ?></td>
													<td class="center" >
														<a href="/cheng/admin.php/Admin/Ordermanage/orderState/onumber/<?php echo ($v["onumber"]); ?>">
	...
	<script type="text/javascript">
		...
		$("#li_1").click(function(){
			window.location="/cheng/admin.php/Admin/Ordermanage/index";
		});
		$("#li_2").click(function(){
			window.location="/cheng/admin.php/Admin/Ordermanage/nonDelivery";
		});
		$("#li_3").click(function(){
			window.location="/cheng/admin.php/Admin/Ordermanage/deliverGoods";
		});
		$("#li_5").click(function(){
			window.location="/cheng/admin.php/Admin/Ordermanage/completeDeal";
		});
	</script>
