        ...
        <div class="page-content">
            ...
            <div class="row" style="padding:0px;height:auto;overflow:hidden;margin-bottom:10px;">
                <div class="col-xs-12 col-sm-8">
                    <a class="btn btn-primary pull-left" style="padding:1px 10px;" href="<?php echo U('Admin/Goodsclass/addClass');?>">
                ...
                <div class="col-xs-12">
                    <div class="table-responsive">
                        <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                            ...
                            <!--遍历查询到的数据-->
                            <tbody>
                                <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr id="fl_<?php echo ($vo['cid']); ?>">
                                    <td id="jj_<?php echo ($vo['cid']); ?>">
                                        <a class="anniu" href="javascript:;" onclick="zhankai('<?php echo ($vo['cid']); ?>','1')" >+</a>
                                    </td>
                                    <td>
                                        <?php echo ($vo['cid']); ?>
                                    </td>
                                    ...
                                    <td>
                                        <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                            <a name="table-edit" class="green" href="<?php echo U('Admin/Goodsclass/modifyClass',array('id'=>$vo['cid']));?>">
                                                <i class="icon-pencil bigger-130"></i>
                                            </a>

                                            <a name="del_<?php echo ($vo['cid']); ?>" class="red" onclick="del(this)" data-toggle="modal" href="#deleteModal">
			...
			success:function(result){
				...
				for(i=0;i<result.length;i++){
					...
					$("#fl_"+id).after('<tr class="erji_'+id+'" id="fl_'+result[i]["cid"]+'">'
						...
						+'</td>'
                       +'<td><img src="/cheng/Public/img/xiabiao.gif" />'+result[i]["cid"]+'</td>'
    ...
    function del(obj){
        ...
        jQuery(function($) {
            ...
            $('#delete-data').on('click',function(){
                $.ajax({
                       url:"/cheng/admin.php/Admin/Goodsclass/deleteClass",
                       type:"post",
                       data:{cid:delid},
