...
<html lang="en">
    ...
    <script src="/cheng/Public/admin/js/jquery.slimscroll.min.js"></script>
    <script src="/cheng/Public/admin/js/jquery.easy-pie-chart.min.js"></script>
    <script src="/cheng/Public/admin/js/jquery.sparkline.min.js"></script>
    <script src="/cheng/Public/admin/js/flot/jquery.flot.min.js"></script>
    <script src="/cheng/Public/admin/js/flot/jquery.flot.pie.min.js"></script>
    <script src="/cheng/Public/admin/js/flot/jquery.flot.resize.min.js"></script>
    <script type="text/javascript">
        jQuery(function($) {
            //设置当前页面的菜单高亮显示 开始
